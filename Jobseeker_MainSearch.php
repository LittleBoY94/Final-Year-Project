...
<script src="js/script.js"></script>
	...
	<title>Jobseeker Main Search</title>
		  ...
		  <p>&nbsp;</p>
			  <div class="col-md-box" style="margin:auto; position:relative;" id="stay1">
			    <div class="boxheight fontcolor2">
			      ...
			      <div class="content">
                    <div align="center">
                      <form action="Jobseeker_Search.php" method="get" style="border:2px solid red; float:left; display:inline-block; margin:20px; padding:10px;" name="searchform">
                        <h4 align="center"> Search any Employers you Like!</h4>
                      ...
                      <form action="Jobseeker_SearchJob.php" method="get" style="border:2px solid red; float:left; display:inline-block; margin:20px; padding:10px;" name="searchform">
