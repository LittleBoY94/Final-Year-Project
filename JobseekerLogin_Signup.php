...
window.location.href = "JobseekerLogin_Signup.php";
</script>';
  $loginUsername = $_POST['txtemailaddress'];
  $LoginRS__query = sprintf("SELECT Jobseeker_Email FROM jobseeker WHERE Jobseeker_Email=%s", GetSQLValueString($loginUsername, "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO jobseeker (Jobseeker_Email, Username, Password) VALUES (%s, %s, %s)",
...
if (isset($_POST['txtusername'])) {
  ...
  $MM_redirectLoginSuccess = "Jobseeker_Homepage.php";
...
window.location.href = "JobseekerLogin_Signup.php";
  ...
  $LoginRS__query=sprintf("SELECT Username, Password FROM jobseeker WHERE Username=%s AND Password=%s",
...
<head>
	...
	<title>Jobseeker Login &amp; Signup</title>
	...
	<link rel="shortcut icon" href="images\Icons\Batch-master\PNG\32x32/user-2.png">
			        ...
			        <div class="thumbnail"> 
			          ...
			          <div class="caption">
			            ...
			            <form name="form2" method="POST" action="<?php echo $editFormAction; ?>">
			              ...
			              <p>
			                <input type="submit" name="btnsubmit2" class=" btn btn-success btn-lg buttonstyle1 fontstyle1" id="btnsubmit2" value="Register">
			              </p>
