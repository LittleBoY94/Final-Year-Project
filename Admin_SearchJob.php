...
<div class="container" id="explore">
			  ...
			  <div class="col-md-box" style="margin:auto; position:relative;">
			    <div class="boxheight fontcolor2">
			      ...
			      <div class="content">
                    ...
                    <div align="center">
                        <form action="Admin_SearchJob.php" method="post" name="searchform">
  ...
  'width=auto, height=auto'); 
   return false;"  style="margin: 10px 10px 5px 300px; position:relative; float:left;">
                          ...
                          <input type="submit" class="btn btn-success btn-lg buttonstyle" style="display: inline-block; float:left; margin: 10px 0px 30px 10px;"  name="btnview"  onclick="window.location.href='Admin_Deletejob.php?Job_ID=<?php echo $row_Recordset2['Job_ID']; ?>'" id="btnview" value="Delete Job" >
                       </div>
