...
$query_Recordset2 = sprintf("SELECT * FROM `admin` WHERE Username = %s", GetSQLValueString($colname_Recordset2, "text"));
...
mysql_select_db($database_busybee, $busybee);
$query_Recordset1 = sprintf("SELECT * FROM JOBSEEKER  WHERE First_Name LIKE %s OR Last_Name LIKE %s OR Gender LIKE %s OR DoB LIKE %s OR Nationality LIKE %s OR Type_Of_Employment LIKE %s OR First_Name LIKE %s OR Last_Name LIKE %s OR Gender LIKE %s OR DoB LIKE %s OR Nationality LIKE %s OR Type_Of_Employment LIKE %s", GetSQLValueString("%" . $colname1_Recordset1 . "%", "text"),GetSQLValueString("%" . $colname1_Recordset1 . "%", "text"),GetSQLValueString("%" . $colname1_Recordset1 . "%", "text"),GetSQLValueString("%" . $colname1_Recordset1 . "%", "text"),GetSQLValueString("%" . $colname1_Recordset1 . "%", "text"),GetSQLValueString("%" . $colname1_Recordset1 . "%", "text"),GetSQLValueString("%" . $colname_Recordset1 . "%", "text"),GetSQLValueString("%" . $colname_Recordset1 . "%", "text"),GetSQLValueString("%" . $colname_Recordset1 . "%", "text"),GetSQLValueString("%" . $colname_Recordset1 . "%", "text"),GetSQLValueString("%" . $colname_Recordset1 . "%", "text"),GetSQLValueString("%" . $colname_Recordset1 . "%", "text"));
...
$sql2 = mysql_query("DELETE FROM jobseeker WHERE Jobseeker_ID=$id")or die(mysql_error());
$sql3 = mysql_query("DELETE FROM education_level WHERE Jobseeker_ID=$id")or die(mysql_error());
$sql4 = mysql_query("DELETE FROM jobseeker_experiences WHERE Jobseeker_ID=$id")or die(mysql_error());
$sql5 = mysql_query("DELETE FROM applyjob WHERE Jobseeker_ID=$id")or die(mysql_error());
...
<script src="js/script.js"></script>
	...
	<title>Admin Search Jobseeker</title>
...
<main id="top" class="masthead" role="main">
  <div class="container">
    ...
    <strong><?php echo $row_Recordset2['Username']; ?><br></div>
  </div>
</main>
...
<div class="container" id="explore">
			  ...
			  <div class="col-md-box" style="margin:auto; position:relative;">
			    <div class="boxheight fontcolor2">
			      ...
			      <div class="content">
                      ...
                      <div align="center">
                        <form action="Admin_SearchJobseeker.php" method="post" name="searchform">
                     ...
                     <div class="content" style="padding:15px;">
                      ...
                      <div align="center">
                        <?php do { ?>
                        <div class="box4"><div class="box1">
                        <table  width="705" height="130" border="1">
                          <tr>
  ...
  'width=auto, height=auto'); 
   return false;" >
                            ...
                            <div class="box3">
                            <form name="form222" method="post" action="Admin_SearchJobSeeker.php"/>
                            <input type="hidden" name="jobseeker_id" value="<?php echo $row_Recordset1['Jobseeker_ID']; ?>" />
                             <input type="submit" class="btn btn-success btn-lg buttonstyle" name="sumit"  id="btnview" onClick="return confirm('Are you sure want to delete?')" value="Delete" ></div></div></form>
