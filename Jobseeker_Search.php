...
mysql_select_db($database_busybee, $busybee);
$query_Recordset2 = sprintf("SELECT * FROM employer WHERE Hiring_Skills LIKE %s OR Location LIKE %s OR Type_Of_Employment LIKE %s OR  Hiring_Skills LIKE %s OR Location LIKE %s OR Type_Of_Employment LIKE %s ", GetSQLValueString("%" . $colname_Recordset2 . "%", "text"),GetSQLValueString("%" . $colname_Recordset2 . "%", "text"),GetSQLValueString("%" . $colname_Recordset2 . "%", "text"),GetSQLValueString("%" . $colname1_Recordset2 . "%", "text"),GetSQLValueString("%" . $colname1_Recordset2 . "%", "text"),GetSQLValueString("%" . $colname1_Recordset2 . "%", "text"));
...
<script src="js/script.js"></script>
	...
	<title>Jobseeker Search Employer</title>
...
<div class="container" id="explore">
	 <div class="section-title">
		  <div class="content">
		    <h2 align="center"> View any Employers you desire!</h2>
	      </div>
		  <p>&nbsp;</p>
			  <div class="col-md-box" style="margin:auto; position:relative;">
			    <div class="boxheight fontcolor2">
			      ...
			      <div class="content">
                    ...
                    <div align="center">
                        <form action="Jobseeker_Search.php" method="post" name="searchform">
                     ...
                     <div class="content" style="padding:15px;">
                       ...
                       <?php do { ?>
                       <div align="center">
                         <table style=" float:left; margin-bottom:10px;" width="1030" height="130" border="1">
