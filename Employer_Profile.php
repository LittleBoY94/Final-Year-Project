...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  mysql_select_db($database_busybee, $busybee);
  $Result1 = mysql_query($updateSQL, $busybee) or die(mysql_error());
echo $id=$_POST['Employer_ID'];
  $updateGoTo = "Employer_Verification.php?id=$id";
  if (isset($_SERVER['QUERY_STRING'])) {
    $updateGoTo .= (strpos($updateGoTo, '?')) ? "&" : "?";
    $updateGoTo .= $_SERVER['QUERY_STRING'];
  }
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1">
  <table width="369" height="426" align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" placeholder="Eg. Abc Sdn Bhd" name="Company_Name" class="textfield" style="color:#000;" value="<?php echo htmlentities($row_Recordset1['Company_Name'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">SSM No:</td>
      <td><input type="text" name="SSM_No" placeholder="Eg. 001234567-P, etc" class="textfield" style="color:#000;" value="<?php echo htmlentities($row_Recordset1['SSM_No'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Year of Establishment:</td>
      <td><input type="text" placeholder="Eg. 6 Years, etc" name="Establishment" class="textfield" style="color:#000;" value="<?php echo htmlentities($row_Recordset1['Establishment'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Industries:</td>
      <td><input type="text" placeholder="Eg. IT Industry, Business Industry, etc" name="Industries" style="color:#000;" class="textfield" value="<?php echo htmlentities($row_Recordset1['Industries'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Company Email:</td>
      <td><input type="text" placeholder="Eg. abc123@gmail.com,etc" name="Company_Email" class="textfield" style="color:#000;" value="<?php echo htmlentities($row_Recordset1['Company_Email'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Company Phone Number:</td>
      <td><input type="text" placeholder="Eg. 034567891, etc" name="Company_PhoneNumber" style="color:#000;" class="textfield" value="<?php echo htmlentities($row_Recordset1['Company_PhoneNumber'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Company Address:</td>
      <td><input type="text" placeholder="Eg. No1, The Core, Jalan ABC" name="Company_Address" class="textfield" style="color:#000;" value="<?php echo htmlentities($row_Recordset1['Company_Address'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Post Code:</td>
      <td><input type="text" placeholder="Eg. 47810, 84300, etc" name="Post_Code" class="textfield" style="color:#000;" value="<?php echo htmlentities($row_Recordset1['Post_Code'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">City:</td>
      <td><input type="text" placeholder="Eg. Petaling Jaya, Puchong, etc" name="City" class="textfield" style="color:#000;" value="<?php echo htmlentities($row_Recordset1['City'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">States:</td>
      <td><input type="text" placeholder="Eg. Johor, Selangor, etc" name="States" class="textfield" style="color:#000;" value="<?php echo htmlentities($row_Recordset1['States'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Country:</td>
      <td><input type="text" placeholder="Eg. Malaysia, Singapore, etc" name="Country" class="textfield" style="color:#000;" value="<?php echo htmlentities($row_Recordset1['Country'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Company Websites:</td>
      <td><input type="text" placeholder="Eg. www.abc123.com, etc" name="Company_Websites" class="textfield" style="color:#000;" value="<?php echo htmlentities($row_Recordset1['Company_Websites'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input type="submit" class="btn btn-success btn-lg buttonstyle" value="Insert Details" /></td>
    </tr>
  </table>
  <p>
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" placeholder="Eg. Java, Accounting, Designer, etc" name="Hiring_Skills" style="color:#000;" class="textfield" value="<?php echo htmlentities($row_Recordset1['Hiring_Skills'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Location:</td>
      <td><input type="text" placeholder="Eg. Selangor, Johor, etc" name="Location" class="textfield" style="color:#000;" value="<?php echo htmlentities($row_Recordset1['Location'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
